...
namespace AS.IdentitySeparation.Infra.CrossCutting.Identity.Configuration
{
    public class ApplicationOAuthProvider : OAuthAuthorizationServerProvider
    {
        ...
        public override async Task GrantResourceOwnerCredentials(OAuthGrantResourceOwnerCredentialsContext context)
        {
            ...
            var oAuthIdentity = await user.GenerateUserIdentityAsync(userManager, new ClaimsIdentity(OAuthDefaults.AuthenticationType));
            var cookiesIdentity = await user.GenerateUserIdentityAsync(userManager, new ClaimsIdentity(CookieAuthenticationDefaults.AuthenticationType));
